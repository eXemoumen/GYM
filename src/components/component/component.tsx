...
export function Main() {
  return (
    <div className="flex h-screen bg-[#121212]">
      <nav className="flex flex-col w-16 bg-[#1E1E1E] p-4 space-y-2">
        <HomeIcon className="text-white h-6 w-6" />
        <BookIcon className="text-white h-6 w-6" />
        <DumbbellIcon className="text-white h-6 w-6" />
        <ListIcon className="text-white h-6 w-6" />
        <SettingsIcon className="text-white h-6 w-6" />
        <NewspaperIcon className="text-white h-6 w-6" />
        <BookOpenIcon className="text-white h-6 w-6" />
        <KeyIcon className="text-white h-6 w-6" />
        <PencilIcon className="text-white h-6 w-6" />
        <CircleIcon className="text-white h-6 w-6" />
      </nav>
      <div className="flex flex-1">
        <div className="flex flex-col flex-1">
          <header className="flex justify-between items-center px-4 bg-[#1E1E1E] text-white">
            <h1 className="text-xl font-bold">MUSCLEWIKI</h1>
            <div className="flex space-x-2">
              <Button className="bg-[#BD1E59] text-white">NEW! Workout Generator</Button>
              <Button variant="ghost">Try it out now</Button>
              <Select>
              ...
              <UserCircleIcon className="text-white h-6 w-6" />
            </div>
          </header>
          <main className="px-4 py-6">
            <div className="flex">
              <img
                alt="Muscle diagram front view"
        ...
        <aside className="w-80 bg-[#1E1E1E] p-4 space-y-4">
          <div className="flex space-x-2">
            <Button variant="secondary">Male</Button>
            <Button>Female</Button>
            <Button className="bg-[#BD1E59] text-white">Advanced</Button>
          </div>
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <DumbbellIcon className="text-white h-4 w-4" />
              <DumbbellIcon className="text-white h-4 w-4" />
              <PersonStandingIcon className="text-white h-4 w-4" />
              <CogIcon className="text-white h-4 w-4" />
              <GoalIcon className="text-white h-4 w-4" />
              <DumbbellIcon className="text-white h-4 w-4" />
              <PencilLineIcon className="text-white h-4 w-4" />
              <CableIcon className="text-white h-4 w-4" />
              <HelpingHandIcon className="text-white h-4 w-4" />
              <TableIcon className="text-white h-4 w-4" />
              <XIcon className="text-white h-4 w-4" />
              <ActivityIcon className="text-white h-4 w-4" />
              <CircleIcon className="text-white h-4 w-4" />
              <CheckIcon className="text-white h-4 w-4" />
              <HeartPulseIcon className="text-white h-4 w-4" />
              <WrenchIcon className="text-white h-4 w-4" />
            </div>
          </div>
          <div>
